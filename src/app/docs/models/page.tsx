...
const metaTags = [
  ...
  { tag: '@random:string:N', effect: 'Generates a random string of length N on insert' },
  { tag: '@random:number:N', effect: 'Generates a random N-digit number on insert' },
  { tag: '@random:string(N)', effect: 'Alternate syntax for @random:string:N' },
  { tag: '@random:number(N)', effect: 'Alternate syntax for @random:number:N' },
