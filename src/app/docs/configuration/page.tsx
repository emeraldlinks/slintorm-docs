  ...
  return (
    <DocLayout>
      ...
      <p style={{ marginBottom: '1rem' }}>
        ...
        in edge runtimes</strong> (Cloudflare Workers, Next.js Edge, Deno Deploy) where the filesystem
        is unavailable. Passing it in Node.js is still recommended: it removes the scan overhead and
